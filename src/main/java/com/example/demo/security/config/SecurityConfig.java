...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    CorsConfigurationSource corsConfigurationSource()
    {
        ...
        // configuration.setAllowedOrigins(List.of("http://localhost:4200", "https://angular-springboot1-60ci9cdiy-zule67.vercel.app"));
        configuration.setAllowedOriginPatterns(List.of("http://localhost:4200", "https://angular-springboot1-one.vercel.app/"));
